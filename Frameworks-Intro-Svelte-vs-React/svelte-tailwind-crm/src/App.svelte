<script>
  ...
  let contacts = [
    ...
    { id: 4, name: 'Stanley', email: 'stanley@navy.us', phone: '600444777', status: 'calientasillas' }
  ];
  ...
  const aEstados = ["activo", "potencial", "inactivo", "calientasillas"];
  ...
  <div class="w-full max-w-5xl space-y-6">
    ...
    <div class="grid md:grid-cols-2 gap-6">
      <section class="bg-white rounded-xl shadow p-4 md:col-span-1">
        ...
        <ContactForm {aEstados} on:addContact={(e) => addContact(e.detail)} />
      </section>
